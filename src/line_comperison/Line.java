...
public class Line {
	...
	public static void main(String[] args) {
     ...
     System.out.println("Length of dis of coordinates"+"("+x1+","+y1+"),"+"("+x2+","+y2+")===>"+dis1); 
     ...
     System.out.println("Length of dis of coordinates"+"("+x1+","+x1+"),"+"("+y2+","+y2+")===>"+dis2);  
	
	
	if(dis1 > dis2)
      {
    	  System.out.println("dis1 is greter than dis2");
      }
      else
      {
    	  System.out.println("dis1 is less than dis2");
      }
	}
}
